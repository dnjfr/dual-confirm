...
from src.db_management.db_configurations import users_tablename, advisors_tablename, users_advisors_tablename, users_passwords_db_connection, advisors_passwords_db_connection, users_passwords_tablename, advisors_passwords_tablename, passkeys_pairs_generation_audit_tablename, users_sessions_audit_tablename
...
from utils.generate_audit_tables_db_pg import create_passkeys_pairs_generation_audit_table, create_sessions_users_audit_table
...
create_passkeys_pairs_generation_audit_table(passkeys_pairs_generation_audit_tablename)
create_sessions_users_audit_table(users_sessions_audit_tablename)